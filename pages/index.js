...
export default function Home() {
  ...
  return (
    <>
      ...
      <Header />
      {/* Banner Section */}
      <Banner subheading={"I build things for the web."} subtitle={"Hi, my  name  is"} title={"Kavita Rawat."} desc={"Welcome to my personal portfolio website. I'm an experienced front-end developer with a passion for creating visually stunning, responsive, and interactive web designs. Take a look at my portfolio to see my skills in action and let's collaborate to bring your project to life."} btnText="Download Resume" btnLink={"/images/Kavita_Resume.pdf"} />
